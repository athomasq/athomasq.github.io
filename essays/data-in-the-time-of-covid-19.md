...
*In this essay I offer such a framework, for understanding the **economic** impact of COVID-19.*
...
Consider the small business example above.  If your prior estimate was that 50% of small businesses would be able to reopen in Q3, the new estimate of  should make you increase the probability of the deep small-biz-driven recession.  But of course that's conditional on the crisis lasting another 4 months or more, which now means you now have *context* for the timelines for the data in bucket 1: vaccine development or clinical trials or herd immunity.

And it doesn't end there.  The very conditions that could lead to small businesses remaining closed for 4 months (lockdowns, shelter-in-place, social distancing) will also diminish the spread of the virus, buying time for healthcare system responses (fast test-and-trace, more ventilators and PPE, vaccine and treatment ) that will lead to a long term "solution" or at least a stable equilibrium.  Meanwhile if small businesses do fail in large numbers, we're likely to see even more aggressive government intervention.  Both of these *decrease* the probability of the third domino falling, even as the second domino teeters.

**The point is not to get everything correct.**  (In such a fast-moving situation with so many unknowns, that's an impossible and indeed counter-productive aspiration).  The point is to be systematic and rigorous in our assimilation of new information: adjusting our priors correctly, understanding the dynamics as they evolve.  By examining data via this kind of structured and disciplined approach -- always keeping in mind asymmetric outcomes, the precautionary principle, fat tails and unknown unknowns, and systemic fragility: in other words, the known limitations of any structured approach -- we put ourselves in the best possible situation to understand it, and hopefully act on it.
